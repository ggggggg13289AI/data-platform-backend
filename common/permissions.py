...
require_manage_members = ProjectPermissions.require_permission(
    ProjectPermissions.PERMISSION_MANAGE_MEMBERS
)
require_manage_studies = ProjectPermissions.require_permission(
