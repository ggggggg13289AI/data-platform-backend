...
# Modified: Added AIAnnotation table creation for production environments
# where report.0001_initial was run before AIAnnotation was added
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Create AIAnnotation table if it doesn't exist
        # This handles production environments where report.0001_initial
        # was run before AIAnnotation was added to the codebase
        ...
        ConditionalAddIndex(
            model_name="aiannotation",
            index=models.Index(fields=["created_at"], name="report_ai_a_created_254924_idx"),
        ),
        # ExportTask and other AlterField operations below
