"""
Report Models - Report storage with version control and deduplication.
"""
...
class AIAnnotation(models.Model):
    """
    AI Annotation for Reports.
    Stores AI-generated or User-corrected annotations for a report.
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    report = models.ForeignKey(Report, on_delete=models.CASCADE, related_name='annotations')

    # Annotation Details
    annotation_type = models.CharField(max_length=50, db_index=True) # e.g. "NER", "Classification", "Summary"
    content = models.TextField() # JSON string or text content
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['report', 'annotation_type']),
